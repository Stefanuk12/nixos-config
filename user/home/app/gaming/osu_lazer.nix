...
let
  # Pause dunst whenever the focused workspace contains an osu! window so
  # notifications can't trigger compositor repaint stalls mid-gameplay.
  # Pending notifications queue up and pop after we leave the workspace.

...

{
  ...
  programs.dbd = {
    ...
    actionMappings = [
      ...
      {
        name = "EventAbility_Survivor";
        key = "Three";
      }
      {
        name = "EventAbility_Killer";
        key = "Three";
      }
    ];
  ...
  programs.steam-launch-options.appLaunchOptions = {
